...
SECRET_KEY = 'django-insecure-u$)ja31q&%c*i22j^orp3kpa0!x#*8-l-9no!49okpbt#^*@o!'
...
# Opcional: Expira completamente cuando el navegador se cierra
SESSION_EXPIRE_AT_BROWSER_CLOSE = True

CSRF_TRUSTED_ORIGINS = [
    'https://phyllodial-unmolested-susana.ngrok-free.dev'
]